  ...
  return (
    <div className="week-component">
      <div className="weekday">
        ...
        <p>{ForecastData ? Math.floor(ForecastData.hourly[1].temp - 273.15) : null}°C</p>
      </div>
      <div className="weekday">
        ...
        <p>{ForecastData ? Math.floor(ForecastData.hourly[2].temp - 273.15) : null}°C</p>
      </div>
      <div className="weekday">
        ...
        <p>{ForecastData ? Math.floor(ForecastData.hourly[3].temp - 273.15) : null}°C</p>
      </div>
      <div className="weekday">
        ...
        <p>{ForecastData ? Math.floor(ForecastData.hourly[4].temp - 273.15) : null}°C</p>
      </div>
      <div className="weekday">
        ...
        <p>{ForecastData ? Math.floor(ForecastData.hourly[5].temp - 273.15) : null}°C</p>
      </div>
      <div className="weekday">
        ...
        <p>{ForecastData ? Math.floor(ForecastData.hourly[6].temp - 273.15) : null}°C</p>
      </div>
      <div className="weekday">
        ...
        <p>{ForecastData ? Math.floor(ForecastData.hourly[7].temp - 273.15) : null}°C</p>
      </div>
    </div>
  );
}
